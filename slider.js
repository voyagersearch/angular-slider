...
(function() {
  ...
  sliderDirective = function($timeout) {
    return {
      ...
      template: '<span class="bar"></span> <span class="bar selection"></span> <span class="pointer"></span> <span class="pointer"></span> <span class="bubble selection">Range: {{ diff }}</span> <span class="bubble limit">{{ floor }}</span> <span class="bubble limit">{{ ceiling }}</span> <span class="bubble low">{{ ngModelLow }}</span> <span class="bubble high">{{ ngModelHigh }}</span>',
      compile: function(element, attributes) {
        var ceilBub, e, flrBub, fullBar, high, highBub, low, lowBub, maxPtr, minPtr, range, selBar, selBub, watchables, _i, _len, _ref, _ref1;
        ...
        _ref = (function() {
          ...
          return _results;
        })(), fullBar = _ref[0], selBar = _ref[1], minPtr = _ref[2], maxPtr = _ref[3], selBub = _ref[4], flrBub = _ref[5], ceilBub = _ref[6], lowBub = _ref[7], highBub = _ref[8];
        low = range ? 'ngModelLow' : 'ngModel';
        high = 'ngModelHigh';
        if (!range) {
          _ref1 = [selBar, maxPtr, selBub, highBub];
            ...
            updateDOM = function() {
              ...
              setPointers = function() {
                ...
                if (range) {
                  ...
                  return offset(selBub, pixelize(offsetLeft(selBar) + halfWidth(selBar) - halfWidth(selBub)));
                }
              };
              ...
              setBindings = function() {
                ...
                bind = function(method) {
                  ...
                  return bindToInputEvents(maxPtr, high, inputEvents[method]);
                };
                _ref2 = ['touch', 'mouse'];
                _results = [];
